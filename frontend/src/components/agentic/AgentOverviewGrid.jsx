          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-2xs font-mono font-medium px-2 py-0.5 rounded bg-slate-800/80 text-slate-400 border border-slate-750">
                  {agent.role}
                </span>
              </div>
            ...
            <div className="mt-3 pt-2 border-t border-slate-800 flex items-center justify-between text-2xs font-mono text-slate-500">
